...
GUI.title ('โปรแกรมบัญทึกข้อมูล') #นี่คือชื่อโปรเเกรม
GUI.geometry('900x400') #นี่คือขนาดโปรแกรม

L1 = Label(GUI,text='โปรแกรมบัญทึกความรู้',font=('Angsana New',30),fg='green')
L1.place(x=30,y=20)
#################################
def Button2():
...
###############SECTION RIGHT###################
LF1 =ttk.LabelFrame(GUI,text='กรอกข้อมูลที่ต้องการลงไป')
LF1.place(x=400,y=50)

v_data = StringVar() # ตัวแปรพิเศษที่ใช้กับข้อความในgui
...
def SaveData():
    ...
    writecsv(text) #บัญทึกลงCSV
    v_data.set('') #เคลียร์ข้อมูลที่อยู่ในช่องกรอก

B4 = ttk.Button(LF1,text='บัญทึก',command=SaveData)
